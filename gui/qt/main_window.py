...
class ElectrumWindow(QMainWindow):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-WLC ' + self.wallet.electrum_version + '  -  ' + os.path.basename(self.wallet.storage.path)
    ...
    def backup_wallet(self):
        ...
        if new_path != path:
            try:
                ...
                QMessageBox.critical(None,"Unable to create backup", _("Electrum-WLC was unable to copy your wallet file to the specified location.")+"\n" + str(reason))
    ...
    def init_menubar(self):
        ...
        tools_menu.addAction(_("Electrum-WLC preferences") if sys.platform == 'darwin' else _("Preferences"), self.settings_dialog)
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-WLC",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum-WLC's focus is speed, with low resource usage and simplifying Worldleadcurrency. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the Worldleadcurrency system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-WLC - " + _("Reporting Bugs"),
    ...
    def notify(self, message):
        if self.tray:
            self.tray.showMessage("Electrum-WLC", message, QSystemTrayIcon.Information, 20000)
    ...
    def create_history_menu(self, position):
        ...
        if be == 'Coinplorer':
            block_explorer = 'https://coinplorer.com/WLC/Transactions/'
        #elif be == 'Blockr.io':
    ...
    def update_receive_qr(self):
        ...
        if addr:
            ...
            p = urlparse.ParseResult(scheme='worldleadcurrency', netloc='', path=addr, params='', query='&'.join(query), fragment='')
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Worldleadcurrency Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid Worldleadcurrency Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_from_URI(self,URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid worldleadcurrency URI:') + '\n' + str(e), _('OK'))
            return
    ...
    def create_contact_menu(self, position):
        ...
        if not item:
            ...
            menu.addAction(_("QR code"), lambda: self.show_qrcode("worldleadcurrency:" + addr, _("Address")))
            if is_editable:
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive worldleadcurrencys.") + " " \
    ...
    def tx_from_text(self, txt):
        ...
        if is_hex:
            try:
                ...
                traceback.print_exc(file=sys.stdout)
                QMessageBox.critical(None, _("Unable to parse transaction"), _("Electrum-WLC was unable to parse your transaction"))
                return
    ...
    def read_tx_from_qrcode(self):
        ...
        if data.startswith("worldleadcurrency:"):
    ...
    def read_tx_from_file(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to read file or no transaction found"), _("Electrum-WLC was unable to open your transaction file") + "\n" + str(reason))
    ...
    def export_privkeys_dialog(self, password):
        ...
        try:
            ...
            export_error_label = _("Electrum-WLC was unable to produce a private key-export.")
    ...
    def do_import_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to import labels"), _("Electrum-WLC was unable to import your labels.")+"\n" + str(reason))
    ...
    def do_export_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to export labels"), _("Electrum-WLC was unable to export your labels.")+"\n" + str(reason))
    ...
    def export_history_dialog(self):
        ...
        try:
            ...
            export_error_label = _("Electrum-WLC was unable to produce a transaction export.")
    ...
    def settings_dialog(self):
        ...
        d = QDialog(self)
        d.setWindowTitle(_('Electrum-WLC Settings'))
        d.setModal(1)
        vbox = QVBoxLayout()
        grid = QGridLayout()
        ...
        if self.need_restart:
            QMessageBox.warning(self, _('Success'), _('Please restart Electrum-WLC to activate the new GUI settings'), _('OK'))



    def run_network_dialog(self):
        if not self.network:
            QMessageBox.warning(self, _('Offline'), _('You are using Electrum-WLC in offline mode.\nRestart Electrum-WLC if you want to get connected.'), _('OK'))
            return
    ...
    def plugins_dialog(self):
        ...
        d.setWindowTitle(_('Electrum-WLC Plugins'))
        d.setModal(1)
